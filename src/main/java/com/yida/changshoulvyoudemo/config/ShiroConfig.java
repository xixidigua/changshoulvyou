...
import com.yida.changshoulvyoudemo.cache.RedisCacheManager;
import com.yida.changshoulvyoudemo.mapper.UserDao;
import com.yida.changshoulvyoudemo.shiro.ShiroRealm;
...
public class ShiroConfig {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        filterChainDefinitionMap.put("/js/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/css/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/font/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/bootstrap/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/image/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/KindEditor/**", "anon");//anon表示匿名访问，不用登录
        filterChainDefinitionMap.put("/My97DatePicker/**", "anon");//anon表示匿名访问，不用登录
        ...
        filterChainDefinitionMap.put("/**","authc");//authc表示登录后，才能访问
