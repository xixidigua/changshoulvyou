package com.yida.changshoulvyoudemo.shiro;


import com.yida.changshoulvyoudemo.cache.ShiroByteSource;
import com.yida.changshoulvyoudemo.entity.Permission;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
      ...
      //3.通过username到数据库中查询有没有该用户
       ...
       // ByteSource byteSourse = ByteSource.Util.bytes(user.getSalt());
        //redis的ByteSource 需要底层序列化
        ByteSource byteSourse = new ShiroByteSource(user.getSalt());
