package com.yida.changshoulvyoudemo.cache;

import com.yida.changshoulvyoudemo.util.ApplicationContextUtils;
...
public class RedisProjectCache implements Cache {
  ...
  private String md5Key(String key){
   ...
   //这里的id，实际上是mapper里的namespace的值
    ...
    public RedisProjectCache(String id){this.id=id;}
    @Override
    public String getId() {
        return this.id;
    }
